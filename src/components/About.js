      ...
      <h1 className="h1__about">About Me.</h1>
        ...
        <div className='about__wrapper'>
          <div className='about__detail__wrapper'>
           <p className="about__info"><span className='first-letter'>W</span>atzUp, Im Ronnel Santos! I'm a highly motivated graduate of Information Technology looking to kick start my career as a Web Developer and IT related projects with a reputable company. Possessing enthusiasm, drive and a positive attitude required to be successful in programming and computer base environment.</p>
           <p className="about__info">I enjoy creating Web Application and accomplishing projects together with highly skilled team to be able to learn more in the process.I'm innovative and equipped with knowledge in programming. Proficient in writing code and debugging system. </p>
           </div>
           <div className='about__skills'>
            <div className='title__skills'>
            <h1><i className="far fa-file-code"></i>Skills</h1>
            </div>
            ...
            <div className='title__skills'>
            <h1><i className="fas fa-laptop-code"></i>Handled Application</h1>
            </div>
